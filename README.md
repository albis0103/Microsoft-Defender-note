...
**note**
AD(Activity Directory):類似Domain的metadata查詢服務，紀錄組織在windows網路環境下相關訊息的目錄服務
example:簡易的window event viewer
<yaml>
Log Name:      Security
Source:        Microsoft-Windows-Security-Auditing
Date:          2026/03/02 22:15:30
**Event ID:      4624**
Task Category: Logon
Level:         Information
...
    Account Domain:   CORP
    Logon ID:         0x3E7
**Logon Type:           3  <-- (3 代表網路登入，例如存取分享資料夾)**
New Logon:
    Security ID:      CORP\j.doe
    **Account Name:     j.doe      <-- (這是 AD 中的使用者帳號)
    Account Domain:   CORP       <-- (這是 AD 的網域名稱)**
    Logon ID:         0x1A2B3C
    Linked Logon ID:  0x0
    Network Account Name: -
    Network Account Domain: -
    Logon GUID:       {a1b2c3d4-e5f6-7890-abcd-1234567890ab}
Process Information:
    Process ID:       0x2e4
    Process Name:     C:\Windows\System32\lsass.exe
Network Information:
    Workstation Name: LAPTOP-SALES01
    **Source Network Address: 192.168.1.55  <-- (發起登入請求的客戶端 IP)**
    Source Port:      54321
</yaml>
**AD延伸之服務**
